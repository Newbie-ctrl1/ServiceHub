        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="secondary-item">
                    ...
                    <img src="{{ secure_asset('images/Other.jpg')}}" alt="secondary-service" class="secondary-img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="trending-section">
        <div class="section-header d-flex justify-content-between align-items-center mb-4">
            <div class="section-heading">
                <h3 class="section-title">Layanan Other</h3>
                <p class="section-subtitle">Temukan berbagai layanan Other dan styling terbaik</p>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-12">
                    <div class="text-center py-5">
                        ...
                        <h4 class="text-muted">Belum Ada Layanan Other</h4>
                        <p class="text-muted">Saat ini belum ada layanan dalam kategori other. Silakan cek kembali nanti.</p>
                    </div>
                </div>
                @endforelse
            </div>
...
function sendProductDetailsToChat(userId, serviceCard, orderNumber) {
    ...
    productMessage += `⚙️ Layanan: ${title}\n`;
