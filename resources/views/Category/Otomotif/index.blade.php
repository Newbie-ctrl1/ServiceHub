        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="secondary-item">
                    ...
                    <img src="{{ secure_asset('images/Otomotif.jpg') }}" alt="secondary-service" class="secondary-img">
    ...
    <div class="trending-section">
        <div class="section-header d-flex justify-content-between align-items-center mb-4">
            <div class="section-heading">
                <h3 class="section-title">Layanan Otomotif</h3>
                <p class="section-subtitle">Temukan berbagai layanan Otomotif dan styling terbaik</p>
            </div>
        ...
        <div class="trending-grid">
            <div class="row g-4">
                @forelse($otomotifServices as $service)
                <div class="col-md-4">
                ...
                <div class="col-12">
                    <div class="text-center py-5">
                        ...
                        <h4 class="text-muted">Belum Ada Layanan Otomotif</h4>
                        <p class="text-muted">Saat ini belum ada layanan dalam kategori otomotif. Silakan cek kembali nanti.</p>
                    </div>
                </div>
                @endforelse
            </div>
