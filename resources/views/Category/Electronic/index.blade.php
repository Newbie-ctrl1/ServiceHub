        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="secondary-item">
                    ...
                    <img src="{{ secure_asset('images/Electronic.jpg') }}" alt="secondary-service" class="secondary-img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="trending-section">
        <div class="section-header d-flex justify-content-between align-items-center mb-4">
            <div class="section-heading">
                <h3 class="section-title">Layanan Service</h3>
                <p class="section-subtitle">Temukan berbagai layanan perbaikan dan instalasi terbaik</p>
            </div>
        ...
        <div class="trending-grid">
            <div class="row g-4">
                @forelse($electronicServices as $service)
                <div class="col-md-4">
                ...
                <div class="col-12">
                    <div class="text-center py-5">
                        ...
                        <h4 class="text-muted">Belum Ada Layanan Electronic</h4>
                        <p class="text-muted">Saat ini belum ada layanan dalam kategori Electronic. Silakan cek kembali nanti.</p>
                    </div>
                </div>
                @endforelse
            </div>
...
<script>
    ...
    function confirmBooking(userId, serviceTitle) {
        if (confirm('Apakah Anda yakin akan memesan layanan "' + serviceTitle + '"?')) {
            ...
            // User mengklik batal
            console.log('Pemesanan dibatalkan oleh user untuk layanan:', serviceTitle);
            // Opsional: tampilkan notifikasi singkat
            showCancelNotification();
        }
    }
    
    // Function untuk menampilkan notifikasi pembatalan
    function confirmBooking(userId, serviceTitle) {
